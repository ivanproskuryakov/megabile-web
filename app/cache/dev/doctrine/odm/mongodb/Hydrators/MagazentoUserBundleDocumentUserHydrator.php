 ...
 */
class MagazentoUserBundleDocumentUserHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['money'])) {
            $value = $data['money'];
            $return = (string) $value;
            $this->class->reflFields['money']->setValue($document, $return);
            $hydratedData['money'] = $return;
        }
        ...
        /** @Field(type="string") */
        if (isset($data['moneyReserved'])) {
            $value = $data['moneyReserved'];
            $return = (string) $value;
            $this->class->reflFields['moneyReserved']->setValue($document, $return);
            $hydratedData['moneyReserved'] = $return;
        }
        ...
        if (isset($data['payDate'])) {
            $value = $data['payDate'];
            $return = $value;
            $this->class->reflFields['payDate']->setValue($document, $return);
            $hydratedData['payDate'] = $return;
        }
        ...
        if (isset($data['apiKey'])) {
            $value = $data['apiKey'];
            $return = (string) $value;
            $this->class->reflFields['apiKey']->setValue($document, $return);
            $hydratedData['apiKey'] = $return;
        }
        return $hydratedData;
    }
}