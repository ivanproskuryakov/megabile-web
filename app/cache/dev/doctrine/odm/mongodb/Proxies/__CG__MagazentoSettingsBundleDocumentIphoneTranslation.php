 ...
 */
class IphoneTranslation extends \Magazento\SettingsBundle\Document\IphoneTranslation implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'user_id', 'text');
    }
