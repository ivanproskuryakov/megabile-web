 ...
 */
class Category extends \Magazento\CatalogBundle\Document\Category implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setXmlParentId($xmlParentId);
    }

    public function getXmlParentId()
    {
        $this->__load();
        return parent::getXmlParentId();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'user_id', 'xml_category_id', 'xml_parent_Id', 'name');
    }
